...
import com.pawegio.homebudget.main.currencies.CurrenciesFragment
...
fun createNavGraph(navController: NavController) {
    navController.graph = navController.createGraph(NavGraph.id, NavGraph.Dest.start) {
        ...
        action(NavGraph.Action.toCurrencies) { destinationId = NavGraph.Dest.currencies }
        ...
        fragment<CurrenciesFragment>(NavGraph.Dest.currencies)
    }
}
